...
BASE_DIR = Path("target/criterion/t_siris")
...
def parse_benchmark_id(benchmark_id: str):
    ...
    # Example: "obtain_master/N4_t3_n4"
    try:
...
def extract_benchmark_data(base_dir: Path) -> pd.DataFrame:
    """Extract t_siris benchmark data from Criterion directories and return a DataFrame."""
    all_data = []
...
def main():
    ...
    csv_file = "t_siris_benchmarks.csv"
    ...
    # No need for pivot table since we already have the format requested
