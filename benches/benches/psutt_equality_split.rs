...
//         // Setup phase (done once outside benchmarks)
...
//         println!("Bench proving starts -------------------------");
//         group.bench_with_input(prove_id, &cred_count, |b, &cred_count| {
//             b.iter(|| {
//                 let mut rng = ark_std::test_rng();
//                 let mut randomized_sigs = Vec::new();
//                 let mut randomized_commitments: Vec<Commitment<Bls12_381>> = Vec::new();

//                 // Proving phase
//                 for psutt_setup in &setup.psutt_setups {
//                     // Randomize signature and commitment
...
//                 (randomized_sigs, randomized_commitments, proof)
//             });
//         });

//         // Benchmark Verification
//         let verify_id = BenchmarkId::from_parameter(format!("verify_credentials_{}", cred_count));
//         println!("Bench verifying starts -------------------------");
//         group.bench_with_input(verify_id, &cred_count, |b, &cred_count| {
//             // Generate proof outside benchmark
//             let mut rng = ark_std::test_rng();
//             let mut randomized_sigs = Vec::new();
//             let mut randomized_commitments: Vec<Commitment<Bls12_381>> = Vec::new();
